...
CREATE TABLE IF NOT EXISTS user_download_prefs (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    po_html TEXT DEFAULT 'Downloads/PO_HTML',
    srv_html TEXT DEFAULT 'Downloads/SRV_HTML',
    challan TEXT DEFAULT 'Downloads/Challan',
    invoice TEXT DEFAULT 'Downloads/Invoice',
    challan_summary TEXT DEFAULT 'Downloads/Challan_Summary',
    invoice_summary TEXT DEFAULT 'Downloads/Invoice_Summary',
    items_summary TEXT DEFAULT 'Downloads/Items_Summary',
    gc TEXT DEFAULT 'Downloads/GC',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
