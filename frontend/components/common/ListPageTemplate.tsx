...
export function ListPageTemplate<T extends Record<string, any>>({
    ...
    return (
        ...
        >
            <div className="flex flex-col h-[calc(100vh-8rem)] gap-8 pb-2">
                ...
                {/* Main Content Area (Table) - Wrapped in Spatial Card for containment */}
                <div className="spatial-card-v2 glow-border-v2 flex-1 w-full overflow-hidden min-h-[500px] flex flex-col">
                    {children ? (
