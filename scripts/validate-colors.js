...
// Design token files need rgb/rgba for shadow values
const IGNORE_FILES = ['constants/design-tokens.ts', 'hooks/useDesignSystem.ts'];
...
files.forEach(file => {
    ...
    // Skip design token definition files (they need rgb/rgba for shadows)
